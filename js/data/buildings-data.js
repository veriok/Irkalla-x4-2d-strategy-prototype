...
const GENERIC_CHAINS = [
  ...
  // ── Settlement Growth Chain (main_settlement only) ──────
  {
    ...
    bonuses: { gold: 5, faction_primary_adv: 1, growthSlots: 1 },
    prerequisites: [],
  ...
  },
  {
    ...
    bonuses: { gold: 10, faction_primary_adv: 2, growthSlots: 2 },
  ...
  },
  {
    ...
    bonuses: { gold: 20, faction_primary_adv: 4, growthSlots: 3 },
  ...
  },
  {
    ...
    bonuses: { faction_primary_adv: 4, growthSlots: 1 },
  ...
  },
  {
    ...
    bonuses: { defense: 0.35, growthSlots: 1 },
