...
const GENERIC_CHAINS = [
  ...
  // ── Training Building Chain ─────────────────────────────
  {
    ...
    factionId: null,
    disabledFactions: [FACTION_IDS.ARCHONATE_GREYHAVEN],
...
const POLEIS_AETHERA_CHAINS = [
  ...
  // ── Aetheric Tower (main_settlement / religious, both elf factions) ─
  {
    id: 'aetheric_tower', name: 'Aetheric Tower', emoji: '🔮',
    cardImg: 'assets/cards/buildings/default_building.png',
    factionId: null,
    allowedLocTypes: ['main_settlement', 'religious'],
    tier: 1, upgradeFromId: null,
    category: BUILDING_CATEGORIES.SCIENTIFIC,
...
const ARCHONATE_GREYHAVEN_CHAINS = [
  ...
  // ── Discipline Hall Chain (fort only, Archonate replacement for mustering/warrior/barracks) ─
  {
    ...
    category: BUILDING_CATEGORIES.TRAINING,
    techRequired: 'warbands',
    cost: { gold: 35, aether: 8 }, buildTurns: 2,
  ...
  },
  {
    ...
    category: BUILDING_CATEGORIES.TRAINING,
    techRequired: 'clan_warfare',
    cost: { gold: 70, aether: 15, tribute: 5 }, buildTurns: 4,
  ...
  {
    id: 'discipline_hall_3', name: 'Eternal Garrison', emoji: '🏰',
    cardImg: 'assets/cards/buildings/discipline_hall_3.png',
    factionId: FACTION_IDS.ARCHONATE_GREYHAVEN,
    allowedLocTypes: ['fort'],
    tier: 3, upgradeFromId: 'discipline_hall_2',
    category: BUILDING_CATEGORIES.TRAINING,
    techRequired: 'battle_formations',
    cost: { gold: 130, aether: 30, tribute: 15 }, buildTurns: 6,
    bonuses: { recruitSpeed: 1, tribute: 0.75 },
    militiaBonus: 2,
    prerequisites: ['discipline_hall_2'],
    mainBuildingTier: 3,
    unlocksBuildings: [],
    description: 'The pinnacle of Archonate military infrastructure. Trains elite phalanx veterans and extracts heavy Tribute from the province.',
  },
];
